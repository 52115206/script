...
//				toolChanger.Add(cutter[i]);
	...
	public IEnumerator SelfRotate(bool down)
	{
...
//		text_num = GUILayout.TextField(text_num);
//		text_num = GUI.TextField(new Rect(150, 20, 120, 30), text_num);
		
//		if(GUILayout.Button("Rotate"))
//		{
//			if(!revolution_on)
////				StartCoroutine(ChooseTool(Convert.ToInt32(text_num)));
//			StartCoroutine(SelfRotate(true));
//		}
		
//		if(GUI.Button(new Rect(150, 70, 120, 30), "ChangeTool"))
//		{
//			if(!selfRotation_on && !revolution_on && !move_on)
//				StartCoroutine(ToolChangeProcess(Convert.ToInt32(text_num)));
//		}
		
//		if(GUI.Button(new Rect(150, 120, 120, 30), "Choose Tool"))
//		{
//			StartCoroutine(ChooseTool(Convert.ToInt32(text_num)));
//		}
...
//		{
////			Vector3 middle_pos = (toolTest.position + toolTest2.position) / 2;
////			Debug.Log(middle_pos.x + "," + middle_pos.y + "," + middle_pos.z);
////			twistGrip.position = middle_pos;
//			twistAxis.parent = twistGrip;
//			GameObject.Find("tools box_3").transform.parent = twistGrip;
//			twistGrip.position = new Vector3(-0.4721795f, twistGrip.position.y, -1.360485f);
//			twistGrip.DetachChildren();
//			twistGrip.RotateAround(centre_point, cw * rotate_direction, 90f);
//		}
	}
