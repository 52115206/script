...
//			Y_Positive_Move();
	...
	{
		if(Mathf.Abs(Y_Part3.position.x - MoveControl_script.Y_part.position.x) > y3_max)
		{
			Y_Part3.position = new Vector3(MoveControl_script.Y_part.position.x - y3_max, Y_Part3.position.y, Y_Part3.position.z);
			if(Mathf.Abs(Y_Part2.position.x - MoveControl_script.Y_part.position.x) > y2_max)
			{
				Y_Part2.position = new Vector3(MoveControl_script.Y_part.position.x - y2_max, Y_Part2.position.y, Y_Part2.position.z);
				if(Mathf.Abs(Y_Part1.position.x - MoveControl_script.Y_part.position.x) > y1_max)
				{
					Y_Part1.position = new Vector3(MoveControl_script.Y_part.position.x - y1_max, Y_Part1.position.y, Y_Part1.position.z);
				}
			}
		}
	}
	...
	{
		if(Mathf.Abs(Y_Part3.position.x - MoveControl_script.Y_part.position.x) < y3_min)
		{
			Y_Part3.position = new Vector3(MoveControl_script.Y_part.position.x - y3_min, Y_Part3.position.y, Y_Part3.position.z);
			if(Mathf.Abs(Y_Part2.position.x - MoveControl_script.Y_part.position.x) < y2_min)
			{
				Y_Part2.position = new Vector3(MoveControl_script.Y_part.position.x - y2_min, Y_Part2.position.y, Y_Part2.position.z);
				if(Mathf.Abs(Y_Part1.position.x - MoveControl_script.Y_part.position.x) < y1_min)
				{
					Y_Part1.position = new Vector3(MoveControl_script.Y_part.position.x - y1_min, Y_Part1.position.y, Y_Part1.position.z);
				}
			}
		}
	}
