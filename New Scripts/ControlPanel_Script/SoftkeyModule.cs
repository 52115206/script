...
public class SoftkeyModule : MonoBehaviour {
	...
	public void Softkey () 
	{
		...
		if (GUI.Button(new Rect((l_x+4*left_x)/1000f*Main.width, l_y/1000f*Main.height, btn_width/1000f*Main.width, btn_height/1000f*Main.height), "", Main.Soft_EMPTY))            
		{
			if(Main.ScreenPower)
				FourthButton();
		}
		
		if (GUI.Button(new Rect((l_x+5*left_x)/1000f*Main.width, l_y/1000f*Main.height, btn_width/1000f*Main.width, btn_height/1000f*Main.height), "", Main.Soft_EMPTY))            
		{
			if(Main.ScreenPower)
				FifthButton();
		}
		
		if (GUI.Button(new Rect((l_x+6*left_x)/1000f*Main.width, l_y/1000f*Main.height, btn_width/1000f*Main.width, btn_height/1000f*Main.height), "", Main.Soft_RIGHT))            
		{
			if(Main.ScreenPower)
				NextPage();
		}
