...
public class PositionModule : MonoBehaviour {
	...
	void ShowOperationScreen()
	{
		...
		if(Main.statusBeforeOperation==1)
		{
			...
			GUI.Label(new Rect((Main.corner_px + 72f)/1000f*Main.width,(Main.corner_py + 33f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.absolute_pos.x), Main.sty_BigXYZ);
			...
			GUI.Label(new Rect((Main.corner_px + 72f)/1000f*Main.width,(Main.corner_py + 83f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.absolute_pos.y), Main.sty_BigXYZ);
			...
			GUI.Label(new Rect((Main.corner_px + 72f)/1000f*Main.width,(Main.corner_py + 133f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),Main.CooStringFormat(CooSystem_script.absolute_pos.z), Main.sty_BigXYZ);
		}
		if(Main.statusBeforeOperation==2)
		{
			...
			if((xBlink&&xDisplayFlag)||!MDIInput_script.isXSelected)
				GUI.Label(new Rect((Main.corner_px + 26.5f)/1000f*Main.width,(Main.corner_py + 33f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"X", Main.sty_BigXYZ);
			GUI.Label(new Rect((Main.corner_px + 72f)/1000f*Main.width,(Main.corner_py + 33f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.relative_pos.x), Main.sty_BigXYZ);
			if((yBlink&&yDisplayFlag)||!MDIInput_script.isYSelected)
				GUI.Label(new Rect((Main.corner_px + 26.5f)/1000f*Main.width,(Main.corner_py + 83f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"Y", Main.sty_BigXYZ);
			GUI.Label(new Rect((Main.corner_px + 72f)/1000f*Main.width,(Main.corner_py + 83f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.relative_pos.y), Main.sty_BigXYZ);
			if((zBlink&&zDisplayFlag)||!MDIInput_script.isZSelected)
				GUI.Label(new Rect((Main.corner_px + 26.5f)/1000f*Main.width,(Main.corner_py + 133f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"Z", Main.sty_BigXYZ);
			GUI.Label(new Rect((Main.corner_px + 72f)/1000f*Main.width,(Main.corner_py + 133f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),Main.CooStringFormat(CooSystem_script.relative_pos.z), Main.sty_BigXYZ);
		}
		if(Main.statusBeforeOperation==3)
		{
			...
			GUI.Label(new Rect((Main.corner_px+55f)/1000f*Main.width,(Main.corner_py+42f)/1000f*Main.height,500f/1000f*Main.width,100f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.relative_pos.x), Main.sty_SmallNum);
			if((yBlink&&yDisplayFlag)||!MDIInput_script.isYSelected)
			...
			GUI.Label(new Rect((Main.corner_px+55f)/1000f*Main.width,(Main.corner_py+66f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.relative_pos.y), Main.sty_SmallNum);
			if((zBlink&&zDisplayFlag)||!MDIInput_script.isZSelected)
			...
			GUI.Label(new Rect((Main.corner_px+55f)/1000f*Main.width,(Main.corner_py+90f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.relative_pos.z), Main.sty_SmallNum);
			...
			GUI.Label(new Rect((Main.corner_px+298f)/1000f*Main.width,(Main.corner_py+42f)/1000f*Main.height,500f/1000f*Main.width,100f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.absolute_pos.x), Main.sty_SmallNum);
			...
			GUI.Label(new Rect((Main.corner_px+298f)/1000f*Main.width,(Main.corner_py+66f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.absolute_pos.y), Main.sty_SmallNum);
