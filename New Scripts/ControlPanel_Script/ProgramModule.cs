...
//		G_instructValue2.Add(-5538f);G_instructValue2.Add(5962f);G_instructValue2.Add(405f);//数值要求-9999-9999
	}
...
//		GUI.Label(new Rect((Main.corner_px + 7f)/1000f*Main.width, (Main.corner_py + 55f)/1000f*Main.height, 345f, 25f/1000f*Main.height+0.8f), test_word, Main.TestGUIStyle);
...
//			GUI.Label(new Rect((Main.corner_px + 4f)/1000f*Main.width, (Main.corner_py + 47f)/1000f*Main.height, 370f, 25f/1000f*Main.height), "", Main.TestGUIStyle);
			if(Main.CodeForAUTO.Count > 0)
			{
				...
				AutoDisplyProgram(Main.corner_py + 47f, Main.corner_px + 7f);
			}
		}
		...
		else if (Main.ProgAUTOFlip==2)
		{
			...
			GUI.Label(new Rect((Main.corner_px + 26.5f)/1000f*Main.width,(Main.corner_py + 147f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.absolute_pos.x), Main.sty_SmallNum);
			...
			GUI.Label(new Rect((Main.corner_px + 26.5f)/1000f*Main.width,(Main.corner_py + 167f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.absolute_pos.y), Main.sty_SmallNum);
			...
			GUI.Label(new Rect((Main.corner_px + 26.5f)/1000f*Main.width,(Main.corner_py + 187f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.absolute_pos.z), Main.sty_SmallNum);
...
//		    GUI.Label(new Rect(380f/1000f*Main.width,321f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.NumberFormat(Main.SpindleSpeed), Main.sty_SmallNum);
			...
			if(Main.CodeForAUTO.Count > 0)
			{
				...
				AutoDisplyProgram(Main.corner_py + 28f, Main.corner_px + 7f);
			}
		}
		...
		else if(Main.ProgAUTOFlip==4)
		{
			...
			GUI.Label(new Rect((Main.corner_px + 2.5f)/1000f*Main.width,(Main.corner_py + 147f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"X", Main.sty_SmallXYZ);
			GUI.Label(new Rect((Main.corner_px + 26.5f)/1000f*Main.width,(Main.corner_py + 147f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.relative_pos.x), Main.sty_SmallNum);
			GUI.Label(new Rect((Main.corner_px + 2.5f)/1000f*Main.width,(Main.corner_py + 167f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"Y", Main.sty_SmallXYZ);
			GUI.Label(new Rect((Main.corner_px + 26.5f)/1000f*Main.width,(Main.corner_py + 167f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.relative_pos.y), Main.sty_SmallNum);
			GUI.Label(new Rect((Main.corner_px + 2.5f)/1000f*Main.width,(Main.corner_py + 187f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"Z", Main.sty_SmallXYZ);
			GUI.Label(new Rect((Main.corner_px + 26.5f)/1000f*Main.width,(Main.corner_py + 187f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(CooSystem_script.relative_pos.z), Main.sty_SmallNum);
			GUI.Label(new Rect((Main.corner_px + 183f)/1000f*Main.width,(Main.corner_py + 126f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"剩余移动量", Main.sty_PosSmallWord);
			GUI.Label(new Rect((Main.corner_px + 171f)/1000f*Main.width,(Main.corner_py + 147f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(Main.remaining_x), Main.sty_SmallNum);
			GUI.Label(new Rect((Main.corner_px + 171f)/1000f*Main.width,(Main.corner_py + 167f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(Main.remaining_y), Main.sty_SmallNum);
			GUI.Label(new Rect((Main.corner_px + 171f)/1000f*Main.width,(Main.corner_py + 187f)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringFormat(Main.remaining_z), Main.sty_SmallNum);
...
//		GUI.Label(new Rect(175f/1000f*Main.width,420f/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height),"", Main.sty_BottomChooseMenu);
	...
	public void G_codeDisplay()
	{
		...
		for(int m=0;m<G_instructValue.Count;m++)
			GUI.Label(new Rect((Main.corner_px + 117f)/1000f*Main.width,(Main.corner_py + 52f +25f*m)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringGet(G_instructValue[m]), Main.sty_SmallNum);
	}
	...
	public void G_codeDisplayNext()
	{
		...
		for(int m=0;m<G_instructValue2.Count;m++)
			GUI.Label(new Rect((Main.corner_px + 368f)/1000f*Main.width,(Main.corner_py + 52f +25f*m)/1000f*Main.height,500f/1000f*Main.width,300f/1000f*Main.height), Main.CooStringGet(G_instructValue2[m]), Main.sty_SmallNum);
	}
...
//    }
	...
	//Todo: 将代码编辑显示相关的程序都整理出来，尽量脱离全局变量，变成一个独立的
    //输入为（显示代码块左上角的X和Y值，显示几行，单行长度）
	void DisplayProgram(float pos_y, float position_x)
    { 
		//程序最后如果不是;则自动补;
		if(Main.CodeForAll.Count != 0 && Main.CodeForAll[Main.CodeForAll.Count-1] != ";")
			Main.CodeForAll.Add(";");
	...
	public void AutoDisplyProgram(float pos_y, float position_x)
	{
		...
		float row_length = 360f, cur_length = 0;	
		int index_str = 0;
