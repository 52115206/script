...
public class MoveControl : MonoBehaviour {
	...
	void FixedUpdate () {
		LightControl_Script.setLight((int)Lights.X, Main.x_return_zero);
		LightControl_Script.setLight((int)Lights.Y, Main.y_return_zero);
		LightControl_Script.setLight((int)Lights.Z, Main.z_return_zero);
